...
<div class="flex md:flex-col flex-row border-[#0AEDFE] rounded-xl border-2 p-2 gap-2">
	<div class="md:grid flex grid-cols-1 gap-2 group mx-auto px-3">
		<div class="flex md:flex-row flex-col items-center gap-7" >
			...
			<span class="text-center text-[#003FA7] ">{quiz.likes}</span>
		...
		<div class="flex md:flex-row flex-col items-center gap-7" >
			...
			<span class="text-center text-[#003FA7] ">{quiz.dislikes}</span>
		</div>
	</div>
	...
	<div class="mx-auto md:grid flex grid-cols-1 gap-2 px-3">
		<div class="flex md:flex-row flex-col items-center gap-7 my-1">
			...
			<p class="mx-auto text-[#003FA7] " use:tippy={{ content: 'How often the activity was started' }}>
				{quiz.plays}
			</p>
		</div>
		<div class="flex md:flex-row flex-col items-center gap-7 my-1">
			...
			<p class="mx-auto text-[#003FA7] " use:tippy={{ content: 'Activity views' }}>{quiz.views}</p>
		</div>
	</div>
</div>
