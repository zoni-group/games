...
>
    ...
    >
        <div class="grid grid-cols-2 grid-rows-2 gap-8 ">
            <div
                class="rounded-lg bg-blue-800 text-white shadow-lg cursor-pointer transition-all p-7"
