...
<div class="flex justify-center  w-full mx-3 ">
	<a href="/view/{quiz.id}" class="sm:h-2/3 sm:w-2/3 w-full flex flex-col justify-center mx-3">
		<div class="  py-4 px-8 bg-white border-[#C0D8FF] border-2 shadow-lg shadow-[#C8DDFF] rounded-lg sm:my-15 my-10 dark:bg-slate-800">
			...
			<div>
				<div class="flex w-full items-center">
					<h2
						class="text-[#003FA7] dark:text-[#003FA7] text-3xl font-semibold truncate pr-2"
					>
						{@html quiz.title}
					</h2>
					<span class="inline-block ml-auto text-[#003FA7]">
						<ImportedOrNot imported={quiz.imported_from_kahoot} />
					</span>
				</div>
				<p
					class="mt-2 text-black dark:text-gray-300 break-all overflow-hidden text-ellipsis h-[4.5rem] block"
				>
					{@html quiz.description}
				</p>
			</div>
			<div class="flex mt-4 text-[#0060C5]">
				<span
