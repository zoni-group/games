...
<svelte:head>
	<title>Zoni® AI/docs - Terms of Service</title>
	<meta
		name="description"
		content="The terms of service of Zoni AI, the open-source activity-application"
	/>
</svelte:head>
...
>
	...
	<h2>What doesn't belong on Zoni AI</h2>
	<p>
		The owner may delete, change and modify any activity. activities with any pornography, illegal
	...
	<p>You have to report illegal content by writing an email to operez@zoni.edu</p>
	...
	<p>
		...
		rule or not. Zoni AI also doesn't provide any (uptime)-guarantee, so Zoni AI could be shut
	...
	<p>
		...
		operez@zoni.edu. Please include the email you registered with on Zoni AI, and, if
		possible, a prove that you are the owner of the account, by, eg., writing the email with the
		email-address which is associated with your Zoni AI-account.
	</p>
	...
	<p>
		...
		still got any questions, please contact me at <a href="https://www.zoni.edu"
			>www.zoni.edu</a
		>
	</p>
</article>
